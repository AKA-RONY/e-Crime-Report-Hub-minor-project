...
<body>
 ...
 <h2 style="text-align: center; margin-bottom: 20px; color: white;font-weight:bold;">REGISTERED FIR ENTRIES </h3>
...
<sql:query dataSource="${ds}" var="rs">
    SELECT fir_id , user_email , name , emergency_contact , category , description ,when_occured_date ,when_occurred_time ,where_occured_location ,FIR_status ,FIR_REPORT_DATE
...
<table class="table table-bordered">
    ...
    <c:forEach var="row" items="${rs.rows}">
        <tr>
            ...
            <td><a href="admin_edit_fir.jsp?id=${row.fir_id}">Edit</a></td>
			<td><a href="admin_delete_fir.jsp?id=${row.fir_id}">Delete</a></td>
