...
<style>
    body {
        ...
        background-size: cover;
          background-image: url('images/qfir1.jpg');
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
                <h2 style="text-align: center;color: white; font-weight:bold;">QUICK FIR</h2>
                <form action="quickFIRServlet" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" id="emergencyContact" name="emergencyContact"
                            placeholder="Enter alternate number" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="location">Where Occured (Location):</label>
